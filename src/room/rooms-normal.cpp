...
bool build_type2(PlayerType *player_ptr, DungeonData *dd_ptr)
{
    ...
    int yval;
    int xval;
    const auto is_pos_found = find_space(player_ptr, dd_ptr, &yval, &xval, 25, 25);
    if (!is_pos_found) {
        return false;
    }
    ...
    auto y1a = yval - randint1(11);
    auto y2a = yval + randint1(10);
    auto x1a = xval - randint1(11);
    auto x2a = xval + randint1(10);

    /* Determine extents of the second room */
    auto y1b = yval - randint1(10);
    auto y2b = yval + randint1(11);
