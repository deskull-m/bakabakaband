...
enum summon_type : int {
    ...
    SUMMON_APE = 16, /*!< 召喚タイプ: 類人猿 */
    SUMMON_ANGEL = 17, /*!< 召喚タイプ: 天使 */
    SUMMON_DEMON = 18, /*!< 召喚タイプ: 悪魔 */
    SUMMON_UNDEAD = 19, /*!< 召喚タイプ: アンデッド */
    SUMMON_DRAGON = 20, /*!< 召喚タイプ: ドラゴン */
    SUMMON_HI_UNDEAD = 22, /*!< 召喚タイプ: 強力なアンデッド */
    SUMMON_HI_DRAGON = 23, /*!< 召喚タイプ: 古代ドラゴン */
    SUMMON_HI_DEMON = 24, /*!< 召喚タイプ: 上級デーモン */
