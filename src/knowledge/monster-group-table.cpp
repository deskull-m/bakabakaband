 ...
 */
const std::vector<std::string> MONRACE_CHARACTERS_GROUP = { "Uniques", "Riding", "Wanted", "Amberites", "Chaosians", "Skeletons", "Zombies", "Crabs", "Fungi", "Mimics", "a", "b", "c", "dD", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o",
