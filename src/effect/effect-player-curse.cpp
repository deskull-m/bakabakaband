...
{
    if ((creature.does_save_against(ep_ptr->rlev)) && !check_multishadow(creature)) {
...
{
    if ((creature.does_save_against(ep_ptr->rlev)) && (ep_ptr->m_ptr->get_r_idx() != MonraceId::KENSHIROU) && !check_multishadow(creature)) {
