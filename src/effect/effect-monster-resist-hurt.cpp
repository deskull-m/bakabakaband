 ...
 * @details `apply_monster_element_resist` と同一の軽減だが、race 由来耐性 (opt-in) でも
 *          発火するハンドラ用に思い出記録を native_resist で条件化した版。二次属性
 *          (chaos / shards / disenchant / nexus) の byte 一致ブロックを集約。挙動不変。
 */
