...
const std::map<AllianceType, std::shared_ptr<Alliance>> alliance_list = {
    { AllianceType::NONE, std::make_unique<AllianceNone>(AllianceType::NONE, tl::nullopt, "NONE", _("無所属", "None"), 0) },
    { AllianceType::AMBER, std::make_unique<AllianceAmber>(AllianceType::AMBER, tl::nullopt, "AMBER", _("アンバー", "Amber"), 350000000L) },
    { AllianceType::COCHAOS, std::make_unique<AllianceCourtOfChaos>(AllianceType::COCHAOS, tl::nullopt, "COCHAOS", _("混沌の宮廷", "Court of Chaos"), 200000000L) },
    { AllianceType::VALINOR, std::make_unique<AllianceValinor>(AllianceType::VALINOR, tl::nullopt, "VALINOR", _("ヴァリノール", "Valinor"), 4000000L) },
    { AllianceType::UTUMNO, std::make_unique<AllianceCourtOfChaos>(AllianceType::UTUMNO, tl::nullopt, "UTUMNO", _("ウトゥムノ", "Utumno"), 3000000L) },
    { AllianceType::JURAL, std::make_unique<AllianceJural>(AllianceType::JURAL, tl::nullopt, "JURAL", _("ジュラル星人", "Jural"), 5500L) },
    { AllianceType::CHINCHINTEI, std::make_unique<AllianceChinChinTei>(AllianceType::CHINCHINTEI, tl::nullopt, "CHINCHINTEI", _("ちんちん亭", "Chin-Chin-Tei"), 191919L) },
    { AllianceType::ODIO, std::make_unique<AllianceOdio>(AllianceType::ODIO, tl::nullopt, "ODIO", _("オディオ", "Odio"), 300000L) },
    { AllianceType::KENOHGUN, std::make_unique<AllianceKenohgun>(AllianceType::KENOHGUN, tl::nullopt, "KENOHGUN", _("拳王軍", "Kenohgun"), 100000L) },
    { AllianceType::FANG_FAMILY, std::make_unique<AllianceFangFamily>(AllianceType::FANG_FAMILY, tl::nullopt, "FANG-FAMILY", _("牙一族", "Fang Family"), 4000L) },
    { AllianceType::KOGAN_RYU, std::make_unique<AllianceKoganRyu>(AllianceType::KOGAN_RYU, tl::nullopt, "KOGAN-RYU", _("虎眼流", "Kogan Ryu"), 10000L) },
    { AllianceType::ELDRAZI, std::make_unique<AllianceEldrazi>(AllianceType::ELDRAZI, tl::nullopt, "ELDRAZI", _("エルドラージ", "Eldrazi"), 120000000L) },
    { AllianceType::UNGOLIANT, std::make_unique<AllianceUngoliant>(AllianceType::UNGOLIANT, tl::nullopt, "UNGOLIANT", _("ウンゴリアント一族", "Ungoliant's Family"), 1500000L) },
    { AllianceType::SHITTO_DAN, std::make_unique<AllianceShittoDan>(AllianceType::SHITTO_DAN, tl::nullopt, "SHITTO-DAN", _("しっと団", "Sitto-Dan"), 1500L) },
    { AllianceType::GE_ORLIC, std::make_unique<AllianceGEOrlic>(AllianceType::GE_ORLIC, tl::nullopt, "GE-ORLIC", _("オーリック朝銀河帝国", "Galactic Empire of Orlic"), 2000000L) },
    { AllianceType::TURBAN_KIDS, std::make_unique<AllianceTurbanKids>(AllianceType::TURBAN_KIDS, tl::nullopt, "TURBAN-KIDS", _("ターバンのガキ共", "Turban Kids"), 20000L) },
    { AllianceType::NAKED_KNIGHTS, std::make_unique<AllianceNakedKnights>(AllianceType::NAKED_KNIGHTS, tl::nullopt, "NAKED-KNIGHTS", _("全裸騎士団", "Naked Nights"), 3000L) },
    { AllianceType::NUMENOR, std::make_unique<AllianceNumenor>(AllianceType::NUMENOR, tl::nullopt, "NUMENOR", _("ヌメノール王国", "Numenor Kingdom"), 1500000L) },
    { AllianceType::GO, std::make_unique<AllianceGO>(AllianceType::GO, tl::nullopt, "GO", _("GO教", "GO"), 1800000L) },
    { AllianceType::THE_SHIRE, std::make_unique<AllianceTheShire>(AllianceType::THE_SHIRE, tl::nullopt, "THE-SHIRE", _("ホビット庄", "The Shire"), 5000L) },
    { AllianceType::HAKUSIN_KARATE, std::make_unique<AllianceTheShire>(AllianceType::HAKUSIN_KARATE, tl::nullopt, "HAKUSIN-KARATE", _("迫真空手部", "Hakusin Karate"), 5000L) },
    { AllianceType::DOKACHANS, std::make_unique<AllianceDokachans>(AllianceType::DOKACHANS, tl::nullopt, "DOKACHANS", _("岡山中高年男児糞尿愛好会", "Dokachans"), 69L) },
    { AllianceType::KETHOLDETH, std::make_unique<AllianceKetholdeth>(AllianceType::KETHOLDETH, tl::nullopt, "KETHOLDETH", _("ケツホルデス家", "Kethholdeth House"), 1919L) },
    { AllianceType::MELDOR, std::make_unique<AllianceMeldor>(AllianceType::MELDOR, tl::nullopt, "MELDOR", _("メルドール", "Meldor"), 5000000L) },
    { AllianceType::ANGARTHA, std::make_unique<AllianceAngartha>(AllianceType::ANGARTHA, tl::nullopt, "ANGARTHA", _("アンガルタ", "Angartha"), 900000L) },
    { AllianceType::GETTER, std::make_unique<AllianceGetter>(AllianceType::GETTER, PatronType::GETTER, "GETTER", _("ゲッター", "Getter"), 200000000L) },
    { AllianceType::PURE_MIRRODIN, std::make_unique<AlliancePureMirrodin>(AllianceType::PURE_MIRRODIN, tl::nullopt, "PURE-MIRRODIN", _("清純なるミラディン", "Pure Mirrodin"), 200000L) },
    { AllianceType::KING, std::make_unique<AllianceKING>(AllianceType::KING, tl::nullopt, "KING", _("KING", "KING"), 150000L) },
    { AllianceType::PHYREXIA, std::make_unique<AlliancePhyrexia>(AllianceType::PHYREXIA, tl::nullopt, "PHYREXIA", _("ファイレクシア", "Phyrexia"), 2000000L) },
    { AllianceType::AVARIN_LORDS, std::make_unique<AllianceAvarinLords>(AllianceType::AVARIN_LORDS, tl::nullopt, "AVARIN-LORDS", _("アヴァリ諸侯同盟", "Avarin Lords"), 1000000L) },
    { AllianceType::GOLAN, std::make_unique<AllianceGOLAN>(AllianceType::GOLAN, tl::nullopt, "GOLAN", _("GOLAN", "GOLAN"), 100000L) },
    { AllianceType::BINJO_BUDDHISM, std::make_unique<AllianceBinzyouBuddhism>(AllianceType::BINJO_BUDDHISM, tl::nullopt, "BINJO-BUDDHISM", _("便乗仏教", "Binjo Buddhism"), 80000L) },
    { AllianceType::ASHINA_CLAN, std::make_unique<AllianceBinzyouBuddhism>(AllianceType::ASHINA_CLAN, tl::nullopt, "ASHINA-CLAN", _("葦名一門", "Ashina Clan"), 180000L) },
    { AllianceType::SUREN, std::make_unique<AllianceSuren>(AllianceType::SUREN, tl::nullopt, "SUREN", _("スレン王国", "Suren Kingdom"), 100000L) },
    { AllianceType::FEANOR_NOLDOR, std::make_unique<AllianceFeanorNoldor>(AllianceType::FEANOR_NOLDOR, tl::nullopt, "FEANOR-NOLDOR", _("フェアノール統一ノルドール", "Feanor Noldor"), 3500000L) },
    { AllianceType::GAICHI, std::make_unique<AllianceGaichi>(AllianceType::GAICHI, tl::nullopt, "GAICHI", _("ガイチ帝国", "Gaichi Empire"), 1100000L) },
    { AllianceType::LEGEND_OF_SAVIOR, std::make_unique<AllianceLegendOfSavior>(AllianceType::LEGEND_OF_SAVIOR, tl::nullopt, "LEGEND-OF-SAVIOR", _("世紀末救世主伝説", "Legend of the Latter-day Savior"), 0L) },
    { AllianceType::TOPHAMHATT, std::make_unique<AllianceTophamHatt>(AllianceType::TOPHAMHATT, tl::nullopt, "TOPHAMHATT", _("トップハムハット一族", "Topham Hatt Family"), 1400000L) },
    { AllianceType::TRIOTHEPANCH, std::make_unique<AllianceTrioThePunch>(AllianceType::TRIOTHEPANCH, tl::nullopt, "TRIOTHEPANCH", _("トリオ・ザ・パンチ", "Trio The Panch"), 50000L) },
    { AllianceType::MEGADETH, std::make_unique<AllianceMegadeth>(AllianceType::MEGADETH, tl::nullopt, "MEGADETH", _("秘密結社メガデス", "Secret Society Megadeth"), 4000L) },
    { AllianceType::KHORNE, std::make_unique<AllianceKhorne>(AllianceType::KHORNE, PatronType::KHORNE, "KHORNE", _("血の神コーン", "Khorne, the Blood God"), 18000000L) },
};
...
Alliance::Alliance(AllianceType id, tl::optional<PatronType> patron_id, std::string tag, std::string name, int64_t base_power)
    : id(id)
    , patron_id(patron_id)
    , tag(tag)
    , name(name)
