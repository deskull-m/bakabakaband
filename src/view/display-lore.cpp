...
void display_monster_kind(lore_type *lore_ptr)
{
    ...
    if (lore_ptr->kind_flags.has_none_of({ MonsterKindType::DRAGON, MonsterKindType::DEMON,
            ...
            MonsterKindType::DOG, MonsterKindType::CAT, MonsterKindType::APE, MonsterKindType::HORSE, MonsterKindType::DEER, MonsterKindType::ELEPHANT, MonsterKindType::LIZARD, MonsterKindType::AVATAR, MonsterKindType::NIGHTSHADE, MonsterKindType::HIPPO,
