...
const std::unordered_map<std::string_view, TerrainCharacteristics> f_info_flags = {
    ...
    { "LESS", TerrainCharacteristics::UP_STAIRS },
    { "MORE", TerrainCharacteristics::DOWN_STAIRS },
    ...
    { "HURT_ROCK", TerrainCharacteristics::STONE },
    ...
    { "HURT_DISI", TerrainCharacteristics::CAN_DISINTEGRATE },
...
const std::unordered_map<std::string_view, TerrainTag> terrain_tags = {
    ...
    { "TRAP_DESTRUCTION", TerrainTag::TRAP_DESTRUCTION },
