...
extern const std::unordered_map<std::string_view, MonsterEraType> r_info_era_flags;
...
extern const std::unordered_map<std::string_view, MonraceDropCategory> r_info_drop_category;
