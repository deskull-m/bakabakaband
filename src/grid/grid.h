...
void place_grid(CreatureEntity &creature, Grid &grid, grid_bold_type pg_type);
void place_bold(CreatureEntity &creature, POSITION y, POSITION x, grid_bold_type gh_type);
