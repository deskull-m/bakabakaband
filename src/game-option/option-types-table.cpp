...
const std::vector<GameOption> option_info = validate_option_info({
    ...
    { &monster_tombstones, false, GameOptionType::MONSTER_TOMBSTONES, "monster_tombstones", _("モンスターが死ぬ度に墓石を立てる（ジョーク）", "Erect tombstones for all dead monsters (joke option)"), GameOptionPage::GAMEPLAY },
    ...
    { &ironman_alliance_hostility, false, GameOptionType::IRONMAN_ALLIANCE_HOSTILITY, "ironman_alliance_hostility",
