...
const EnumClassFlagGroup<MonsterAbilityType> RF_ABILITY_SUMMON_MASK = {
    ...
    MonsterAbilityType::S_DEAD_UNIQUE, MonsterAbilityType::S_NASTY, MonsterAbilityType::S_GOLEM, MonsterAbilityType::S_CATS, MonsterAbilityType::S_PUYO, MonsterAbilityType::S_HOMO,
    MonsterAbilityType::S_PERVERT
};
