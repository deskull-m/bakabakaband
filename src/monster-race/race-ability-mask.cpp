...
const EnumClassFlagGroup<MonsterAbilityType> RF_ABILITY_SUMMON_MASK = {
    ...
    MonsterAbilityType::S_FAIRY, MonsterAbilityType::S_APE, MonsterAbilityType::S_BIRD, MonsterAbilityType::S_ANGEL, MonsterAbilityType::S_DEMON, MonsterAbilityType::S_UNDEAD, MonsterAbilityType::S_DRAGON,
    ...
    MonsterAbilityType::S_DEAD_UNIQUE, MonsterAbilityType::S_NASTY, MonsterAbilityType::S_GOLEM, MonsterAbilityType::S_CAT, MonsterAbilityType::S_PUYO, MonsterAbilityType::S_HOMO,
    MonsterAbilityType::S_PERVERT, MonsterAbilityType::S_WALL, MonsterAbilityType::S_INSECT, MonsterAbilityType::S_ELDRAZI,
    MonsterAbilityType::S_ROBOT
};
