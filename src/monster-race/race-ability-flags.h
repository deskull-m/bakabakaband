...
enum class MonsterAbilityType {
    ...
    S_CHOASIANS = 95, /* Summon Choasians */
    S_UNIQUE = 96, /* Summon Unique Monster */
    S_DEAD_UNIQUE = 97, /* Summon Dead Unique Monster */
    S_NASTY = 98, /* Summon Nasty Monster */
    S_GOLEM = 99, /* Summon Golem */
    BO_VOID = 100, /*!< モンスター能力: ヴォイド・ボルト / Void Bolt */
    BO_ABYSS = 101, /*!< モンスター能力: アビス・ボルト / Abyss Bolt */
    BR_VOID = 102, /*!< モンスター能力: 虚無のブレス / Breathe Void */
    BR_ABYSS = 103, /*!< モンスター能力: 深淵のブレス / Breathe Abyss */
    BA_VOID = 104, /*!< モンスター能力: 虚無のボール / Void Ball */
    BA_ABYSS = 105, /*!< モンスター能力: 深淵のボール / Abyss Ball */
    BA_METEOR = 106, /*!< モンスター能力: 隕石のボール / Meteor Ball */
    BO_METEOR = 107, /*!< モンスター能力: 隕石のボルト / Meteor Bolt */
    BO_LITE = 108, /*!< モンスター能力: 光のボルト（スターライトアロー） / Starlight arrow */
