 ...
 * ("dies", "destroyed")
 */
bool monster_living(MonraceId r_idx)
{
    auto *r_ptr = &monraces_info[r_idx];
 ...
 * 実質バーノール＝ルパート用。
 */
bool no_questor_or_bounty_uniques(MonraceId r_idx)
{
    switch (r_idx) {
        /*
         ...
         */
    case MonraceId::BANORLUPART:
    case MonraceId::BANOR:
    case MonraceId::LUPART:
        return true;
    default:
        return false;
    }
