...
std::string get_monster_kind_type_name(MonsterKindType kind)
{
    ...
    case MonsterKindType::CITIZEN:
        return _("市民", "citizen");
    case MonsterKindType::TREEFOLK:
        return _("ツリーフォーク", "treefolk");
    case MonsterKindType::VIRUS:
        return _("ウイルス", "virus");
    case MonsterKindType::SPHINX:
        return _("スフィンクス", "sphinx");
    case MonsterKindType::SCORPION:
        return _("蜥", "scorpion");
    case MonsterKindType::MINDCRAFTER:
        return _("超能力者", "mindcrafter");
    case MonsterKindType::TANUKI:
        return _("狸", "tanuki");
    case MonsterKindType::CHAMELEON:
