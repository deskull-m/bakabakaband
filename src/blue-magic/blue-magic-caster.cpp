...
static bool cast_blue_rocket(CreatureEntity &creature, bmc_type *bmc_ptr)
{
    ...
    const auto damage = monspell_bluemage_damage(creature, MonsterAbilityType::ROCKET, bmc_ptr->plev, DAM_ROLL);
...
static bool cast_blue_shoot(CreatureEntity &creature, bmc_type *bmc_ptr)
{
    ...
    const auto damage = monspell_bluemage_damage(creature, MonsterAbilityType::SHOOT, bmc_ptr->plev, DAM_ROLL);
...
static bool cast_blue_hand_doom(CreatureEntity &creature, bmc_type *bmc_ptr)
{
    ...
    fire_ball_hide(creature, AttributeType::HAND_DOOM, dir, bmc_ptr->plev * 3, 0);
    return true;
}
...
static bool cast_blue_teleport_back(CreatureEntity &creature)
{
    const auto pos = target_set(creature, TARGET_KILL).get_position();
    if (!pos) {
        return false;
    ...
    const auto m_name = exe_blue_teleport_back(creature, *pos);
    if (!m_name) {
        return true;
    }
...
static bool cast_blue_teleport_away(CreatureEntity &creature)
{
    ...
    (void)fire_beam(creature, AttributeType::AWAY_ALL, dir, 100);
    return true;
}
...
static bool cast_blue_psy_spear(CreatureEntity &creature, bmc_type *bmc_ptr)
{
    ...
    const auto damage = monspell_bluemage_damage(creature, MonsterAbilityType::PSY_SPEAR, bmc_ptr->plev, DAM_ROLL);
    (void)fire_beam(creature, AttributeType::PSY_SPEAR, dir, damage);
    return true;
}

static bool cast_blue_make_trap(CreatureEntity &creature)
{
    const auto pos = target_set(creature, TARGET_KILL).get_position();
    if (!pos) {
        return false;
...
static bool switch_cast_blue_magic(CreatureEntity &creature, bmc_type *bmc_ptr)
{
    ...
    case MonsterAbilityType::DISPEL:
        return cast_blue_dispel(creature);
    case MonsterAbilityType::ROCKET:
        return cast_blue_rocket(creature, bmc_ptr);
    case MonsterAbilityType::SHOOT:
        return cast_blue_shoot(creature, bmc_ptr);
    ...
    case MonsterAbilityType::TELE_TO:
        return cast_blue_teleport_back(creature);
    case MonsterAbilityType::TELE_AWAY:
        return cast_blue_teleport_away(creature);
    ...
    case MonsterAbilityType::S_KIN:
        return cast_blue_summon_kin(creature, bmc_ptr);
    case MonsterAbilityType::S_CYBER:
        return cast_blue_summon_cyber(creature, bmc_ptr);
    case MonsterAbilityType::S_MONSTER:
        return cast_blue_summon_monster(creature, bmc_ptr);
    case MonsterAbilityType::S_MONSTERS:
        return cast_blue_summon_monsters(creature, bmc_ptr);
    case MonsterAbilityType::S_ANT:
        return cast_blue_summon_ant(creature, bmc_ptr);
    case MonsterAbilityType::S_SPIDER:
        return cast_blue_summon_spider(creature, bmc_ptr);
    case MonsterAbilityType::S_HOUND:
        return cast_blue_summon_hound(creature, bmc_ptr);
    case MonsterAbilityType::S_HYDRA:
        return cast_blue_summon_hydra(creature, bmc_ptr);
    case MonsterAbilityType::S_FAIRY:
        return cast_blue_summon_fairy(creature, bmc_ptr);
    case MonsterAbilityType::S_APE:
        return cast_blue_summon_ape(creature, bmc_ptr);
    case MonsterAbilityType::S_BIRD:
        return cast_blue_summon_bird(creature, bmc_ptr);
    case MonsterAbilityType::S_INSECT:
        return cast_blue_summon_insect(creature, bmc_ptr);
    case MonsterAbilityType::S_ANGEL:
        return cast_blue_summon_angel(creature, bmc_ptr);
    case MonsterAbilityType::S_DEMON:
        return cast_blue_summon_demon(creature, bmc_ptr);
    case MonsterAbilityType::S_UNDEAD:
        return cast_blue_summon_undead(creature, bmc_ptr);
    case MonsterAbilityType::S_DRAGON:
        return cast_blue_summon_dragon(creature, bmc_ptr);
    case MonsterAbilityType::S_HI_UNDEAD:
        return cast_blue_summon_high_undead(creature, bmc_ptr);
    case MonsterAbilityType::S_HI_DRAGON:
        return cast_blue_summon_high_dragon(creature, bmc_ptr);
    case MonsterAbilityType::S_AMBERITES:
        return cast_blue_summon_amberite(creature, bmc_ptr);
    case MonsterAbilityType::S_CHOASIANS:
        return cast_blue_summon_choasian(creature, bmc_ptr);
    case MonsterAbilityType::S_UNIQUE:
        return cast_blue_summon_unique(creature, bmc_ptr);
    case MonsterAbilityType::S_DEAD_UNIQUE:
        return cast_blue_summon_dead_unique(creature, bmc_ptr);
    case MonsterAbilityType::S_NASTY:
        return cast_blue_summon_nasty(creature, bmc_ptr);
    case MonsterAbilityType::S_GOLEM:
        return cast_blue_summon_golem(creature, bmc_ptr);
    case MonsterAbilityType::S_CAT:
        return cast_blue_summon_cats(creature, bmc_ptr);
    case MonsterAbilityType::S_PERVERT:
        return cast_blue_summon_perverts(creature, bmc_ptr);
    case MonsterAbilityType::S_PUYO:
        return cast_blue_summon_puyo(creature, bmc_ptr);
    case MonsterAbilityType::S_HOMO:
        return cast_blue_summon_homo(creature, bmc_ptr);
