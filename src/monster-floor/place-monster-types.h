...
enum place_monster_type {
    ...
    PM_AMBUSH = 0x00020000, /*!< モンスター生成フラグ: 1回の白兵攻撃を行ってくる */
    PM_IGNORE_LEVEL = 0x00040000, /*!< モンスター生成フラグ: レベルを無視して生成する */
    PM_HAVE_MASTER = 0x00080000, /*!< モンスター生成フラグ: 主を持つ */
    PM_ALLIANCE_LIMIT = 0x00100000, /*!< モンスター生成フラグ: アライアンス制約 */
};
