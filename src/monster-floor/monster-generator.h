...
using summon_specific_pf = tl::optional<MONSTER_IDX>(CreatureEntity &, POSITION, POSITION, DEPTH, summon_type, BIT_FLAGS, tl::optional<MONSTER_IDX>);
...
tl::optional<MONSTER_IDX> place_specific_monster(CreatureEntity &creature, POSITION y, POSITION x, MonraceId r_idx, BIT_FLAGS mode, tl::optional<MONSTER_IDX> summoner_m_idx = tl::nullopt);
...
bool alloc_monster(CreatureEntity &creature, int min_dis, BIT_FLAGS mode, summon_specific_pf summon_specific, int max_dis = 65535);
