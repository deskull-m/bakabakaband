...
bool activate_missile_1(CreatureEntity &creature)
{
    ...
    (void)fire_bolt(player, AttributeType::MISSILE, dir, Dice::roll(2, 6));
    return true;
}
...
bool activate_missile_2(CreatureEntity &creature)
{
    ...
    (void)fire_bolt(player, AttributeType::MISSILE, dir, 150);
    return true;
}
...
bool activate_bolt_acid_1(CreatureEntity &creature)
{
    ...
    (void)fire_bolt(player, AttributeType::ACID, dir, Dice::roll(5, 8));
    return true;
}
...
bool activate_bolt_elec_1(CreatureEntity &creature)
{
    ...
    (void)fire_bolt(player, AttributeType::ELEC, dir, Dice::roll(4, 8));
    return true;
}
...
bool activate_bolt_fire_1(CreatureEntity &creature)
{
    ...
    (void)fire_bolt(player, AttributeType::FIRE, dir, Dice::roll(9, 8));
    return true;
}
...
bool activate_bolt_cold_1(CreatureEntity &creature)
{
    ...
    (void)fire_bolt(player, AttributeType::COLD, dir, Dice::roll(6, 8));
    return true;
}
...
bool activate_ball_pois_1(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::POIS, dir, 12, 3);
    return true;
}
...
bool activate_ball_cold_1(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::COLD, dir, 48, 2);
    return true;
}
...
bool activate_ball_cold_2(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::COLD, dir, 100, 2);
    return true;
}
...
bool activate_ball_cold_3(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::COLD, dir, 400, 3);
    return true;
}
...
bool activate_ball_fire_1(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::FIRE, dir, 72, 2);
    return true;
}
...
bool activate_ball_fire_2(CreatureEntity &creature, std::string_view name)
{
    ...
    (void)fire_ball(player, AttributeType::FIRE, dir, 120, 3);
    return true;
}
...
bool activate_ball_fire_3(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::FIRE, dir, 300, 3);
    return true;
}
...
bool activate_ball_fire_4(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::FIRE, dir, 100, 2);
    return true;
}
...
bool activate_ball_elec_2(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::ELEC, dir, 100, 3);
    return true;
}
...
bool activate_ball_elec_3(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::ELEC, dir, 500, 3);
    return true;
}
...
bool activate_ball_acid_1(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::ACID, dir, 100, 2);
    return true;
}
...
bool activate_ball_nuke_1(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::NUKE, dir, 100, 2);
    return true;
}
...
bool activate_rocket(CreatureEntity &creature)
{
    ...
    (void)fire_ball(player, AttributeType::ROCKET, dir, 250 + player.level * 3, 2);
    return true;
}
...
bool activate_ball_water(CreatureEntity &creature, std::string_view name)
{
    ...
    (void)fire_ball(player, AttributeType::WATER, dir, 200, 3);
    return true;
}
...
bool activate_ball_dark(CreatureEntity &creature, std::string_view name)
{
    ...
    (void)fire_ball(player, AttributeType::DARK, dir, 250, 4);
    return true;
}
...
bool activate_ball_mana(CreatureEntity &creature, std::string_view name)
{
    ...
    (void)fire_ball(player, AttributeType::MANA, dir, 250, 4);
    return true;
}
