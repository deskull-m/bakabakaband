...
const std::map<MonsterAbilityType, const monster_power> monster_powers = {
    ...
    { MonsterAbilityType::BA_GRAVITY, { 42, 46, 85, 500, 90, A_INT, _("超重力", "gravity storm") } },
    ...
    { MonsterAbilityType::S_CHOASIANS, { 49, 125, 90, 0, 50, A_INT, _("混沌の王族の召喚", "summon Lords of Chaos") } },
    ...
    { MonsterAbilityType::S_CAT, { 25, 40, 70, 0, 30, A_INT, _("猫の召喚", "summon cats") } },
    ...
    { MonsterAbilityType::S_ELDRAZI, { 40, 70, 85, 0, 45, A_INT, _("エルドラージの召喚", "summon Eldrazi") } },
    { MonsterAbilityType::S_ROBOT, { 32, 55, 78, 0, 38, A_INT, _("ロボットの召喚", "summon robots") } },
...
const std::map<MonsterAbilityType, concptr> monster_powers_short = {
    ...
    { MonsterAbilityType::S_INSECT, _("虫", "Insects") },
    { MonsterAbilityType::S_FAIRY, _("フェアリー", "Fairies") },
    { MonsterAbilityType::S_BIRD, _("鳥", "Birds") },
    ...
    { MonsterAbilityType::S_CHOASIANS, _("混沌の王族", "Lords of Chaos") },
    ...
    { MonsterAbilityType::S_CAT, _("ネコ", "Cats") },
    ...
    { MonsterAbilityType::S_ELDRAZI, _("エルドラージ", "Eldrazi") },
    { MonsterAbilityType::S_ROBOT, _("ロボット", "Robots") },
};
