...
const std::vector<std::string_view> race_explanations = {
    ...
    _("類人猿は知能と腕力を併せ持つ獣です。木登りや道具の扱いに長けています。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Apes are beasts combining intellect and strength. They are skilled at climbing and handling tools. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("水棲哺乳類は知的で頑健な水中の獣です。水難に強く、長く泳ぎ続けられます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Aquatic mammals are intelligent and robust underwater beasts. They withstand drowning and can swim for long. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("恐竜は太古の巨大な獣です。圧倒的な腕力と体力を誇りますが知能は低いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Dinosaurs are gigantic ancient beasts. They boast overwhelming strength and stamina but low intellect. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("牛は力強く頑健な獣です。優れた体力を持ちますが動きは緩慢です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Bovines are powerful and robust beasts. They have great stamina but move slowly. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("サメは水中の獰猛な捕食者です。鋭い牙を持ち水難に強いですが地上は不得手です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Sharks are ferocious aquatic predators. With sharp fangs and resistance to water, but ill-suited to land. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ヒドラは多頭の巨大な獣です。並外れた体力と毒への耐性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Hydras are gigantic multi-headed beasts. They possess extraordinary stamina and resistance to poison. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ナメクジは鈍重で粘液質の獣です。動きは遅いですが酸への耐性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Slugs are slow, slimy beasts. They move slowly but resist acid. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("タコは器用で知的な水中の獣です。多くの腕を器用に操り水難に強いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Octopuses are dexterous, intelligent aquatic beasts. They wield many arms deftly and resist water. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("イカは素早く器用な水中の獣です。水難に強いですが地上では弱いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Squids are swift, dexterous aquatic beasts. They resist water but are weak on land. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ハーピーは翼を持つ半人半鳥の獣です。空を舞い素早く動きます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Harpies are winged half-human, half-bird beasts. They soar through the sky and move swiftly. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("鹿は優美で素早い獣です。鋭い感覚と俊敏さを持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Deer are graceful, swift beasts. They have keen senses and quickness. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("象は巨大で力強い獣です。比類なき腕力と体力を持ちますが鈍重です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Elephants are huge, powerful beasts. They have unrivaled strength and stamina but are slow. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("トカゲは素早い爬虫類の獣です。火への耐性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Lizards are swift reptilian beasts. They resist fire. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("カバは巨大で頑健な半水生の獣です。力強く水難にも強いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Hippos are huge, robust semi-aquatic beasts. They are powerful and resist water. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("猪は猛々しく頑健な獣です。突進する勇猛さを持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Boars are fierce, robust beasts. They possess the bravery to charge. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("兎は小さく非常に素早い獣です。俊敏ですが肉体は脆弱です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Rabbits are small, very swift beasts. They are agile but physically frail. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("蠍は毒針を持つ隠密な獣です。毒への耐性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Scorpions are stealthy beasts with venomous stingers. They resist poison. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("狸は化けるのが得意な獣です。賢く、人を欺く術に長けています。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Tanuki are beasts skilled at shapeshifting. They are clever and adept at deceiving others. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("栗鼠は小さく敏捷な獣です。木登りに長け非常に素早いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Squirrels are small, nimble beasts. They are skilled climbers and very swift. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("人狼は人と狼の力を併せ持つ獣です。力強く、傷の癒えも早いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Werewolves are beasts combining human and wolf power. They are strong and heal quickly. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ナーガは半人半蛇の知的な獣です。力強さと毒への耐性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Nagas are intelligent half-human, half-serpent beasts. They have strength and resistance to poison. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("蟹は硬い甲殻を持つ水辺の獣です。頑丈で水難に強いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Crabs are shore beasts with hard shells. They are sturdy and resist water. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ワームは単純で頑健な獣です。知能は低いですが傷の癒えが早いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Worms are simple, robust beasts. They have low intellect but heal quickly. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("クラーケンは巨大な海の怪物です。圧倒的な力と水難への耐性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Krakens are gigantic sea monsters. They have overwhelming power and resistance to water. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("深きものは半人半魚の海の眷属です。水難に強く、長命です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Deep ones are half-human, half-fish kin of the sea. They resist water and are long-lived. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ヒルは血を吸う鈍重な獣です。傷の癒えが早いですが知能は低いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Leeches are slow, blood-sucking beasts. They heal quickly but have low intellect. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("クラゲは漂う水中の獣です。毒を持ちますが肉体は脆弱です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Jellyfish are drifting aquatic beasts. They possess venom but have frail bodies. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ミノタウロスは牛頭の巨人です。圧倒的な力と混乱への耐性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Minotaurs are bull-headed giants. They have overwhelming strength and resistance to confusion. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("スフィンクスは謎を司る賢き獣です。知性と力を兼ね備えています。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Sphinxes are wise beasts of riddles. They combine intellect and strength. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ビホルダーは多眼の浮遊する怪物です。優れた魔力と視覚を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Beholders are floating, many-eyed monsters. They possess great magical power and vision. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("目は浮遊する単眼の怪物です。鋭い視覚を持ちますが肉体を持ちません。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Eyes are floating, single-eyed monsters. They have sharp vision but no real body. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ボルテックスは渦巻くエネルギーの存在です。実体を持たず素早く漂います。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Vortices are beings of swirling energy. They have no real body and drift swiftly. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ウーズは不定形の粘体です。酸への耐性を持ちますが鈍重です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Oozes are amorphous slimes. They resist acid but are slow. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("幽霊は実体を持たぬ不死の存在です。隠密と魔法防御に長けています。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Ghosts are incorporeal undead. They excel at stealth and magic resistance. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("リッチは強大な魔力を持つ不死者です。卓越した知性と魔法防御を誇ります。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Liches are undead with immense magical power. They boast superb intellect and magic resistance. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("植物は動かぬ生命体です。頑健で毒に強いですが俊敏さに欠けます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Plants are sessile lifeforms. They are robust and resist poison but lack agility. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("菌類は胞子で増える生命体です。毒に強いですが知能は低いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Fungi are spore-spreading lifeforms. They resist poison but have low intellect. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("エレメンタルは元素の精霊です。実体を超えた力を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Elementals are spirits of the elements. They possess power beyond mere flesh. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ホラーは正気を蝕む異形の存在です。見る者に恐怖を与えます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Horrors are aberrant beings that erode sanity. They instill fear in those who see them. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ナイトシェードは闇に潜む不死者です。隠密と魔法に長けています。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Nightshades are undead lurking in darkness. They excel at stealth and magic. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("クイルスルグは脈打つ召喚の肉塊です。攻撃手段を持たず魔力で他を呼びます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Quylthulgs are pulsing masses of summoning flesh. They lack attacks and call others by magic. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("イクシツザチトルはエイに似た邪悪な水棲種族です。水中で力を発揮します。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Ixitxachitls are evil, ray-like aquatic creatures. They thrive underwater. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ミミックは物体に擬態する怪物です。隠れて獲物を待ち伏せます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Mimics are monsters that disguise as objects. They hide and ambush their prey. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("猿空間の住人は奇妙な異界の猿です。器用で素早い動きを見せます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Denizens of the space of monkeys are strange otherworldly apes. They move deftly and swiftly. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("プヨは弾力のある粘体です。柔らかく酸に強いですが俊敏さに欠けます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Puyos are bouncy slimes. They are soft and acid-resistant but lack agility. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("野獣は荒々しい本能のままに生きる獣です。力強く獰猛です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Wild beasts live by their fierce instincts. They are powerful and ferocious. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("量子生物は確率に揺らぐ不可思議な存在です。観測を逃れる素早さを持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Quantum beings are mysterious entities that fluctuate by probability. They possess elusive swiftness. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("エルドラージは無を喰らう異次元の超存在です。並外れた力と魔的耐性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Eldrazi are otherworldly beings that devour the void. They have extraordinary power and resistances. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("スケイヴンは群れをなす邪悪な鼠人です。狡猾で素早く、毒に強いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Skaven are evil ratmen that swarm in numbers. They are cunning, swift, and resist poison. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("異星人は地球外より来た知的生命体です。未知の科学と素早さを操ります。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Aliens are intelligent lifeforms from beyond the stars. They wield unknown science and swiftness. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ファイレクシア人は機械と肉が融合した異形です。毒に強く力強いです。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Phyrexians are aberrations fusing machine and flesh. They resist poison and are powerful. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("旧支配者は宇宙の彼方より来た邪神です。比類なき力と魔力を備えます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Great Old Ones are evil deities from beyond the cosmos. They wield unrivaled power and magic. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("アヴァターは神の化身たる存在です。あらゆる面で卓越しています。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Avatars are incarnations of the divine. They excel in all aspects. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("プレインズウォーカーは次元を渡り歩く強大な魔道師です。絶大な魔力を誇ります。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Planeswalkers are mighty mages who travel the planes. They boast immense magical power. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ウイルスは増殖する微小な存在です。毒に強く素早く広がりますが脆弱です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Viruses are tiny, self-replicating beings. They resist poison and spread swiftly but are frail. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("混沌の王族は混沌の血を引く高貴な存在です。力と魔と混沌への耐性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Chaosians are noble beings of chaotic blood. They have strength, magic, and resistance to chaos. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("顔面は宙に浮かぶ顔の怪物です。視覚に優れますが手足を持ちません。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Faces are floating visage monsters. They have keen sight but no limbs. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("手は這い回る切り離された手の怪物です。器用に動き獲物を掴みます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Hands are crawling severed-hand monsters. They move deftly and grasp their prey. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("壁は動く岩石の壁です。並外れた頑健さを誇りますが鈍重です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Walls are moving walls of stone. They boast extraordinary sturdiness but are slow. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("船舶は意思を持つ巨大な船の怪物です。圧倒的な頑健さと水への適性を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Ships are gigantic sentient vessel monsters. They have overwhelming sturdiness and affinity for water. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("車輪は転がり回る輪の怪物です。素早く動きますが意思の疎通は困難です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Wheels are rolling wheel monsters. They move swiftly but are hard to communicate with. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("爆発物は今にも爆ぜそうな危険な存在です。火に強いですが脆く不安定です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Explosives are dangerous beings on the verge of bursting. They resist fire but are fragile and unstable. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("警報機は侵入を告げる仕掛けの怪物です。鋭い感知力を持ちますが戦闘は不得手です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Alarms are contraption monsters that herald intruders. They have keen perception but are poor at combat. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("紙は薄く軽い紙で出来た存在です。素早いですが極めて脆弱です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Papers are beings made of thin, light paper. They are swift but extremely frail. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("木人は木で出来た存在です。頑健ですが火を恐れます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Wooden beings are made of wood. They are robust but fear fire. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("鉄人は鉄で出来た頑強な存在です。圧倒的な頑健さを誇ります。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Iron beings are made of sturdy iron. They boast overwhelming durability. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("銅人は銅で出来た頑健な存在です。電撃に強い体を持ちます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Copper beings are made of copper. They have bodies resistant to electricity. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("石人は石で出来た鈍重な存在です。並外れた頑健さを誇ります。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Stone beings are made of stone. They boast extraordinary sturdiness. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("銀人は銀で出来た気高い存在です。光に強く魔法防御に優れます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Silver beings are made of silver. They resist light and have strong magic defense. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("金人は金で出来た豪奢な存在です。腐食に強く頑健です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Gold beings are made of gold. They resist corrosion and are robust. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("ミスリル人はミスリルで出来た希少な存在です。軽く頑健で魔法防御に優れます。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Mithril beings are made of mithril. They are light, robust, and have strong magic defense. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("アダマンタイト人は最硬の金属で出来た存在です。無比の頑健さを誇ります。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Adamantite beings are made of the hardest metal. They boast unmatched sturdiness. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("糞人は汚物で出来た不快な存在です。毒に強いですが嫌われ者です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Feces beings are made of filth. They resist poison but are reviled. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("肉人は寄せ集めの肉で出来た存在です。傷の癒えが早く頑健です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
        "Flesh beings are made of assembled meat. They heal quickly and are robust. They cannot be chosen at character creation and exist mainly as such monsters."),
    _("漆黒鋼人は漆黒の鋼で出来た存在です。闇に強く極めて頑健です。プレイヤーが作成時に選ぶことはできず、もっぱら同系のモンスターとして存在します。",
