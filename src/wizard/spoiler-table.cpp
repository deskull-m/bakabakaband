...
const std::vector<grouper> group_item_list = {
    ...
    { { ItemKindType::FLAVOR_SKELETON, ItemKindType::BOTTLE, ItemKindType::JUNK, ItemKindType::SPIKE, ItemKindType::FLASK, ItemKindType::READING_MATTER }, _("その他", "Misc") },
};
...
const std::vector<flag_desc> slay_flags_desc = {
    ...
    { TR_SLAY_FEMALE, _("女性", "Female") },
    { TR_KILL_FEMALE, _("*女性*", "XFemale") },
...
const std::vector<flag_desc> misc_flags3_desc = {
    ...
    { TR_ESP_HOMO, _("ホモ（レズ）感知", "Sense Homosexuals") },
    ...
    { TR_STANDARDIZED, _("規格品", "Standardized") },
};
