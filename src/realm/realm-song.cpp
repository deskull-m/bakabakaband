 ...
 * @param song 魔法効果のID
 */
static void start_singing(CreatureEntity &creature, SPELL_IDX spell, int32_t song)
{
    /* Remember the song index */
    set_singing_song_effect(creature, song);
...
tl::optional<std::string> do_music_spell(CreatureEntity &creature, SPELL_IDX spell, SpellProcessType mode)
{
    ...
    case 0:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_SLOW);
        }
    ...
    case 1:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_BLESS);
        }
    ...
    case 2:
...

        {
            ...
            if (cast) {
                ...
                fire_bolt(creature, AttributeType::SOUND, dir, dice.roll());
            }
        }
        break;
    ...
    case 3:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_STUN);
        }

        {
            ...
            if (cont) {
                stun_monsters(creature, dice.roll());
            }
        }
    ...
    case 4:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_L_LIFE);
        }
    ...
    case 6:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_FEAR);
        }

        {
            ...
            if (cont) {
                project_all_los(creature, AttributeType::TURN_ALL, power);
            }
        }
    ...
    case 8:
        ...
        if (cast) {
            ...
            set_singing_count(creature, 0);
            start_singing(creature, spell, MUSIC_DETECT);
        }

        {
            ...
            if (cont) {
                ...
                if (count >= 11) {
                    ...
                    if (plev > 39 && count < 19) {
                        set_singing_count(creature, count + 1);
                    }
                }
                if (count >= 6) {
    ...
    case 9:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_PSI);
        }

        {
            ...
            if (cont) {
                project_all_los(creature, AttributeType::PSI, dice.roll());
            }
        }
    ...
    case 10:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_ID);
        }

        {
             ...
             */
            if (cont || cast) {
                project(creature, 0, rad, creature.y, creature.x, 0, AttributeType::IDENTIFY, PROJECT_ITEM);
            }
        }
    ...
    case 11:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_STEALTH);
        }
    ...
    case 12:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_CONF);
        }
    ...
    case 13:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_SOUND);
        }

        {
            ...
            if (cont) {
                project_all_los(creature, AttributeType::SOUND, dice.roll());
            }
        }
    ...
    case 15:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_CHARM);
        }

        {
            ...
            if (cont) {
                charm_monsters(creature, dice.roll());
            }
        }
    ...
    case 16:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_WALL);
        }

        {
             ...
             */
            if (cont || cast) {
                project(creature, 0, 0, creature.y, creature.x, 0, AttributeType::DISINTEGRATE, PROJECT_KILL | PROJECT_ITEM | PROJECT_HIDE);
            }
        }
        break;
    ...
    case 17:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_RESIST);
        }
    ...
    case 18:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_SPEED);
        }
    ...
    case 19: {
        ...
        if (cast) {
            ...
            project(creature, 0, rad, creature.y, creature.x, power, AttributeType::AWAY_ALL, PROJECT_KILL);
        }
    } break;
    ...
    case 20:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_DISPEL);
        }

        {
            ...
            if (cont) {
                dispel_monsters(creature, m_dice.roll());
                dispel_evil(creature, e_dice.roll());
            }
        }
        break;
    ...
    case 21:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_SARUMAN);
        }
    ...
    case 22: {
        ...
        if (cast) {
            ...
            fire_beam(creature, AttributeType::SOUND, dir, dice.roll());
        }
    } break;
    ...
    case 24:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_QUAKE);
        }
    ...
    case 25:
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_STASIS);
        }
    ...
    case 27: {
        ...
        if (cont) {
            dispel_monsters(creature, dice.roll());
        }
    ...
    case 28: {
        ...
        if (cast) {
            ...
            start_singing(creature, spell, MUSIC_H_LIFE);
        }
    ...
    case 30: {
        ...
        if (cast) {
            ...
            fire_ball(creature, AttributeType::SOUND, dir, dice.roll(), rad);
        }
    } break;
    ...
    case 31:
        ...
        if (cast) {
            ...
            rfu.set_flags(flags);
            start_singing(creature, spell, MUSIC_INVULN);
        }
